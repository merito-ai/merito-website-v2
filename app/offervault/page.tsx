...
function Eyebrow({ text }: { text: string }) {
  return (
    <div className="inline-flex items-center bg-[#ed1a24] px-[12px] py-[4px] sm:py-[6px] rounded-full">
...
export default function OfferVaultPage() {
  return (
    <main className="bg-white">
      {/* Hero */}
      <section className="relative mx-auto max-w-[1300px] sm:px-5 pt-8">
        <div className="relative h-[355px] sm:h-[422px] sm:rounded-[11px] overflow-hidden">
          <Image
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center gap-5 px-8">
            ...
            <h1 className="font-[family-name:var(--font-poppins)] font-bold sm:font-semibold text-[24px] sm:text-[48px] text-white leading-normal">
              Ideas That Shape the{" "}
              <span className="text-[#ed1a24]">Future of Talent.</span>
            </h1>
            <p className="font-semibold text-[14px] sm:text-[24px] text-white leading-[165%] max-w-[800px]">
      ...
      <section className="w-full bg-[#fafafa]">
        <div className="max-w-[1115px] mx-auto px-5 py-12 flex flex-col items-start sm:items-center gap-6 text-left sm:text-center">
          <h2 className="font-[family-name:var(--font-poppins)] font-bold sm:font-semibold text-[24px] sm:text-[32px] text-black">
            No more offer Backouts
          </h2>
          <p className="text-[12px] sm:text-[16px] text-[#4b4b4d] leading-[165%] max-w-[700px]">
          ...
          <div className="flex flex-col items-start sm:items-center gap-3 w-full sm:w-auto">
            <ContactTrigger
              className="bg-[#ed1a24] text-white font-[family-name:var(--font-poppins)] font-semibold text-[16px] w-full sm:w-auto h-[48px] sm:h-[50px] px-[20px] sm:px-8 rounded-[5px] sm:rounded-[8px] flex items-center justify-center transition-all duration-200 hover:bg-black hover:text-white sm:hover:scale-[1.03] sm:hover:shadow-[0_8px_24px_rgba(0,0,0,0.25)] active:scale-[0.97]"
            >
              REGISTER NOW
            </ContactTrigger>
            <p className="hidden sm:block text-[14px] font-medium text-[#6d6f74]/70">
      ...
      <section className="max-w-[1000px] mx-auto px-5 py-12">
        <div className="relative w-full aspect-video rounded-none sm:rounded-[12px] overflow-hidden sm:shadow-2xl">
          <VideoThumbnail
      ...
      <section className="w-full border-t border-[#f0f0f0]">
        <div className="max-w-[1136px] mx-auto px-5 py-12 flex flex-col gap-[20px] sm:gap-[60px]">
          <div className="flex flex-col items-start sm:items-center gap-4 sm:gap-5 text-left sm:text-center">
            <h2 className="font-[family-name:var(--font-poppins)] font-bold sm:font-semibold text-[24px] sm:text-[32px] text-black">
              Frequent Last-minute Backouts?
            </h2>
            <p className="text-[12px] sm:text-[16px] text-[#4b4b4d] leading-[165%] max-w-[800px]">
              The study shows there are more than 40% candidates backouts post offer. Offer-vault helps you to overcome this challenge.
            </p>
          </div>
          <div className="flex flex-col sm:grid sm:grid-cols-2 gap-[20px] sm:gap-[40px] justify-items-center">
            {problems.map((p, i) => (
              <div
                key={p.title}
              ...
              >
                ...
                <div className="absolute sm:relative left-[94px] sm:left-auto top-1/2 sm:top-auto -translate-y-1/2 sm:translate-y-0 w-[calc(100%-102px)] sm:w-auto flex flex-col gap-[7px] sm:gap-3 text-left">
                  ...
                  <p className="text-[10px] sm:text-[16px] text-[#4b4b4d] sm:leading-[155%]">{p.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-[#fef7f3] py-12">
        <div className="max-w-[1282px] mx-auto px-5 flex flex-col gap-[20px] sm:gap-[50px]">
          <div className="flex flex-col items-start sm:items-center gap-4 sm:gap-5 text-left sm:text-center">
            <h2 className="font-[family-name:var(--font-poppins)] font-bold sm:font-semibold text-[24px] sm:text-[32px] text-black">
              How it works?
            </h2>
          ...
          <div className="flex flex-col lg:flex-row gap-[16px] sm:gap-8 items-start">
            {/* Steps */}
            <div className="flex gap-[16px] sm:gap-[56px] items-start flex-shrink-0">
              {/* Number dots + line */}
              <div className="flex flex-col gap-[12px] sm:gap-[14px] relative">
                {/* single connector line behind the cells */}
                <div className="pointer-events-none absolute left-1/2 top-[12px] sm:top-[25px] bottom-[12px] sm:bottom-[25px] w-px -translate-x-1/2 bg-[#ed1a24]/30" />
                {steps.map((step) => (
                  <div
                    key={step.num}
                    className="relative h-[59px] sm:h-[118px] flex items-center justify-center"
                  >
                    <div
                      className="size-[25px] sm:size-[50px] rounded-[17px] sm:rounded-full flex items-center justify-center font-[family-name:var(--font-poppins)] font-medium text-[9px] sm:text-[18px] flex-shrink-0 relative"
              ...
              {/* Step cards */}
              <div className="flex flex-col gap-[12px] sm:gap-[14px] w-full sm:w-[492px]">
                {steps.map((step) => (
                  <div
                    key={step.num}
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-[7px] sm:gap-3">
                      ...
                      <p className="text-[10px] sm:text-[15px] text-[#3c3f45] sm:leading-[155%]">{step.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Sidebar callout */}
            <div className="bg-[#fdf0ec] rounded-[6px] sm:rounded-[12px] p-[16px] sm:p-[24px] flex flex-col gap-[16px] sm:gap-5 flex-1">
              <div className="flex gap-[18px] sm:gap-4 items-start">
                <Image
                  ...
                  height={39}
                  unoptimized
                  className="size-[20px] sm:size-[39px] flex-shrink-0"
                />
                <p className="font-[family-name:var(--font-poppins)] font-medium text-[9px] sm:text-[16px] text-black leading-[155%]">
              ...
              <div className="relative h-[147px] sm:h-[292px] w-full rounded-[8px] overflow-hidden">
                <VideoThumbnail
          ...
          {/* Green highlight */}
          <div className="bg-[#eaf5e6] rounded-[3px] sm:rounded-[10px] flex gap-[12px] sm:gap-[40px] items-center px-[19px] sm:px-[60px] py-[6px] sm:py-[20px]">
            <Image
              ...
              height={54}
              unoptimized
              className="size-[17px] sm:size-[54px] flex-shrink-0"
            />
            <p className="font-[family-name:var(--font-poppins)] font-semibold text-[10px] sm:text-[20px] text-black sm:leading-[155%]">
      ...
      {/* Reputation Index */}
      <section className="max-w-[1200px] mx-auto px-5 py-12 flex flex-col gap-[20px] sm:gap-[50px]">
        <div className="flex flex-col items-start sm:items-center gap-4 sm:gap-5 text-left sm:text-center">
          <Eyebrow text="IMPACT" />
          <h2 className="font-[family-name:var(--font-poppins)] font-bold sm:font-semibold text-[24px] sm:text-[32px] text-black">
      ...
      <section className="bg-[#fef7f3] py-12">
        <div className="max-w-[1200px] mx-auto px-5 flex flex-col items-start sm:items-center gap-[20px] sm:gap-[50px]">
          <div className="flex flex-col items-start sm:items-center gap-4 sm:gap-5 text-left sm:text-center">
            <h2 className="font-[family-name:var(--font-poppins)] font-bold sm:font-semibold text-[24px] sm:text-[32px] text-black">
          ...
          <div className="relative aspect-video sm:h-[450px] sm:aspect-auto w-full max-w-[900px] rounded-[8px] sm:rounded-[12px] overflow-hidden">
            <VideoThumbnail
      ...
      {/* CTA */}
      <section className="max-w-[1115px] mx-auto px-5 py-12 flex flex-col items-start sm:items-center gap-[20px] sm:gap-[25px] text-left sm:text-center">
