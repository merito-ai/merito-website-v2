...
const articles: Article[] = [
  ...
  { slug: "choose-right", category: "HIRING STRATEGY", titleBefore: "HOW TO CHOOSE", titleRed: "RIGHT", excerpt: "Four mental models that separate good hiring decisions from reactive ones.", tagline: "DONT HIRE AN ANY AGENCY HIRE RIGHT ONE", thumbnail: "/insights-thumbnails/How to choose right.png" },
  ...
  { slug: "strategy-2026", category: "TALENT STRATEGY", titleBefore: "YOUR 2026", titleRed: "STRATEGY", excerpt: "The talent landscape is shifting. Here's how forward-thinking companies are positioning for the year ahead.", tagline: "2026 WONT WAIT, NOR SHOULD YOUR HIRING STRATEGY", thumbnail: "/insights-thumbnails/Your 2026 stratergy.jpg" },
  { slug: "hire-from-within", category: "EXECUTIVE SEARCH", titleBefore: "HIRE FROM", titleRed: "WITHIN", excerpt: "Internal mobility done right. When promoting from within beats external search — and when it doesn't.", tagline: "THE RIGHT HIREFEELS LIKE THEY WERE ALWAYS THERE", thumbnail: "/insights-thumbnails/hire from within.jpg" },
